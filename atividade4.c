...
// função para acirar um novo para lista retornar
void insertAtBeginning(struct NOde** head, int value){
    struct Node* newNode = createNsssssode(value);
    newNode->next = *head;
    *head = newNode;
}
...
int main() {
    ...
    //vou inserir de um no 
    printf("\n Dados de entrada para inseri a lista de inicio");
    scanf("%d",&value);
    insertAtBeginning(&head, value);
    
    //como inserir 
    printf("\n os dados de inseirod na lista são:\n");
    displayList(head);
